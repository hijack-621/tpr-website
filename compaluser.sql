...
-- ----------------------------
-- Table structure for 5c_tab
-- ----------------------------
DROP TABLE IF EXISTS `5c_tab`;
CREATE TABLE `5c_tab`  (
  `id` int(8) UNSIGNED NOT NULL AUTO_INCREMENT,
  `TPR` char(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Model` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `issueTime` date NULL DEFAULT NULL,
  `Failure_Symptom` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Root_Cause` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Failure_Analysis` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Corrective_Action` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `bios_system`  (
  ...
  `py_update` char(6) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for bizcom_check_data
-- ----------------------------
DROP TABLE IF EXISTS `bizcom_check_data`;
CREATE TABLE `bizcom_check_data`  (
...
-- ----------------------------
-- Table structure for bizcom_fail_data
-- ----------------------------
DROP TABLE IF EXISTS `bizcom_fail_data`;
CREATE TABLE `bizcom_fail_data`  (
...
-- ----------------------------
-- Table structure for bizcom_testlog
-- ----------------------------
DROP TABLE IF EXISTS `bizcom_testlog`;
CREATE TABLE `bizcom_testlog`  (
  ...
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9989 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for bizcom_vifi_check
-- ----------------------------
DROP TABLE IF EXISTS `bizcom_vifi_check`;
CREATE TABLE `bizcom_vifi_check`  (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `TPR` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for bizcom_wednesday
-- ----------------------------
DROP TABLE IF EXISTS `bizcom_wednesday`;
CREATE TABLE `bizcom_wednesday`  (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `ceb_testlog`  (
  ...
  `PN` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 296154 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1111344289 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `cgs_testlog`  (
  ...
  `PN` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 326100 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
-- ----------------------------
-- Table structure for cgstestlogsendfile
-- ----------------------------
DROP TABLE IF EXISTS `cgstestlogsendfile`;
CREATE TABLE `cgstestlogsendfile`  (
  `PPID` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `eco_system`  (
  ...
  `tpm` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `igs_testlog`  (
  ...
  `PN` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2011658 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
-- ----------------------------
-- Table structure for ivy_check_data
-- ----------------------------
DROP TABLE IF EXISTS `ivy_check_data`;
CREATE TABLE `ivy_check_data`  (
  `PPID` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Test_time` date NOT NULL,
  `Station` varchar(25) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Fail_Item` varchar(25) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
-- ----------------------------
-- Table structure for ivy_fail_data
-- ----------------------------
DROP TABLE IF EXISTS `ivy_fail_data`;
CREATE TABLE `ivy_fail_data`  (
  `Test_time` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `TPR` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Station` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Result` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for ivy_testlog
-- ----------------------------
DROP TABLE IF EXISTS `ivy_testlog`;
CREATE TABLE `ivy_testlog`  (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `TPR` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `PPID` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `Station` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
...
-- ----------------------------
-- Table structure for ivy_vifi_check
-- ----------------------------
DROP TABLE IF EXISTS `ivy_vifi_check`;
CREATE TABLE `ivy_vifi_check`  (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `TPR` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `File_Week` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Station` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for ivy_wednesday
-- ----------------------------
DROP TABLE IF EXISTS `ivy_wednesday`;
CREATE TABLE `ivy_wednesday`  (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Week` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
-- ----------------------------
-- Table structure for matrix_qc2
-- ----------------------------
DROP TABLE IF EXISTS `matrix_qc2`;
CREATE TABLE `matrix_qc2`  (
  `PN` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Model` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `RGB test` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Brighness test` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `US K/B Test` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `KB_backlight` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Touchpad` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Camera` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `MIC` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Apple MIC Test` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `L/R Speak` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `MP4 Test` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Touch screen` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Smart Card Test` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `RFID Test` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Fingerprint` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Wireless Test` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `BT` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `WWAN` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `SIM Card` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `SD card` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `LED Test` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Lid Test` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Charge` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `USB_TEST` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `HDMI Test` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `IE-Charger` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `TPC-HDMI` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Fan Test` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `PAID Test` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `RAM8G` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `LAN TEST` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Thermal` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `OA3.0` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Thunderbolt` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `TypC_AR_USB` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `TypC_NAR_USB` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `matrix_rlc_sh`  (
  `DELL_PN` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  ...
  `QC1` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `HDD_Ver` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `RUNIN` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Q3_Image_Ver` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `OBA` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `Last_TPM_FW` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `TPM_FW` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Time_TPM_FW` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Update_TPM_FW` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `SystemID` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `SystemID_2` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `PlatformConfig` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `PlatformTags64W` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `SDS_DPK` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `GetELog64W` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `MfgMode64W` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `MSR_VER` int(11) NULL DEFAULT NULL,
  `Last_Update_Date` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Old_BIOS_Ver` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `NewBios_Time` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `lflag` int(1) NOT NULL DEFAULT 0
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `model`  (
  `No` int(255) NOT NULL AUTO_INCREMENT,
  `Model` char(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `DMname` char(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 1350 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for modelintpr
-- ----------------------------
DROP TABLE IF EXISTS `modelintpr`;
CREATE TABLE `modelintpr`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `model` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `series` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `CGS` int(11) NULL DEFAULT NULL,
  `RLC_SH` int(11) NULL DEFAULT NULL,
  `CEP` int(11) NULL DEFAULT NULL,
  `CEB` int(11) NULL DEFAULT NULL,
  `TSI` int(11) NULL DEFAULT NULL,
  `IGS` int(11) NULL DEFAULT NULL,
  `RLC_INDIA` int(11) NULL DEFAULT NULL,
  `Regenersis_INDIA` int(11) NULL DEFAULT NULL,
  `Bizcom` int(11) NULL DEFAULT NULL,
  `IVY` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 117 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for modeltotpr
-- ----------------------------
DROP TABLE IF EXISTS `modeltotpr`;
CREATE TABLE `modeltotpr`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Model` varchar(25) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ModelToTPR` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `npi_model`  (
  ...
  `insertime` timestamp NULL DEFAULT NULL
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
-- ----------------------------
-- Table structure for npi_owner_copy1
-- ----------------------------
DROP TABLE IF EXISTS `npi_owner_copy1`;
CREATE TABLE `npi_owner_copy1`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `username` char(25) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `dept` char(25) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Owner` char(25) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
-- ----------------------------
-- Table structure for npi_owner_program
-- ----------------------------
DROP TABLE IF EXISTS `npi_owner_program`;
CREATE TABLE `npi_owner_program`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `username` char(25) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `dept` char(25) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Owner` char(25) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `npi_primary`  (
  ...
  `bstation` char(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `rlc_sh_testlog`  (
  ...
  `PN` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 279758 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
-- ----------------------------
-- Table structure for testlog_issue_record
-- ----------------------------
DROP TABLE IF EXISTS `testlog_issue_record`;
CREATE TABLE `testlog_issue_record`  (
  `TPR` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Station` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `Date` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `PPID` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `0KB` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for timecookie
-- ----------------------------
DROP TABLE IF EXISTS `timecookie`;
CREATE TABLE `timecookie`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `primary_id` char(25) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `cookiename` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `tsi_testlog`  (
  ...
  `PN` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8749 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `user`  (
  ...
  `last_sid` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `mid` char(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `weekdate`  (
  ...
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 31501 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `bios` AS select tpr tpr ,count(*) biosno from bios_system where Status!=1 and Status!=5 and Status!=2 group by tpr ;

-- ----------------------------
-- View structure for eco
-- ----------------------------
DROP VIEW IF EXISTS `eco`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `eco` AS select tpr ,count(*) econo from eco_system where Status=0 group by tpr ;

-- ----------------------------
-- View structure for faca
-- ----------------------------
DROP VIEW IF EXISTS `faca`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `faca` AS select tpr tpr,count(*) facano from cgs_check_data where Compal_check is null or Compal_check=' ' group by tpr union all select tpr tpr,count(*) facano from rlc_sh_check_data where Compal_check is null or Compal_check='' group by tpr union all select tpr tpr,count(*) facano from cep_check_data where Compal_check is null or Compal_check='' group by tpr union all select tpr tpr,count(*) facano from tsi_check_data where Compal_check is null or Compal_check='' group by tpr union all select tpr tpr,count(*) facano from igs_check_data where Compal_check is null or Compal_check='' group by tpr union all select tpr tpr,count(*) facano from bizcom_check_data where Compal_check is null or Compal_check='' group by tpr union all  select tpr tpr,count(*) facano from ceb_check_data where Compal_check is null or Compal_check='' group by tpr ;

-- ----------------------------
-- View structure for facaecobios
-- ----------------------------
DROP VIEW IF EXISTS `facaecobios`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `facaecobios` AS select tprfacaeco.tpr,tprfacaeco.facano,tprfacaeco.econo,bios.biosno from tprfacaeco left join bios on tprfacaeco.tpr = bios.tpr ;

-- ----------------------------
-- View structure for facano
-- ----------------------------
DROP VIEW IF EXISTS `facano`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `facano` AS select tprview.tpr,faca.facano facano from tprview left join faca on tprview.tpr=faca.tpr ;

-- ----------------------------
-- View structure for facaview
-- ----------------------------
DROP VIEW IF EXISTS `facaview`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `facaview` AS (select distinct cep_check_data.Model as model,cep_check_data.PPID as ppid,cep_check_data.Station as station,cep_check_data.Fail_Item as fail,cep_check_data.Fail_Detail as fdetail,cep_check_data.Test_time as ttime ,cep_check_data.Correct as correct,cep_check_data.TPR_owner as towner,cep_check_data.Compal_owner as cowner ,cep_check_data.TPR_FA as fa,cep_check_data.Action as action,cep_check_data.Compal_check as Compal_check,cep_check_data.update_time as uptime from cep_check_data where cep_check_data.Compal_check is null or cep_check_data.Compal_check=''  order by ttime DESC ) UNION all (select distinct cgs_check_data.Model ,cgs_check_data.PPID,cgs_check_data.Station,cgs_check_data.Fail_Item,cgs_check_data.Fail_Detail as fdetail,cgs_check_data.Test_time,cgs_check_data.Correct,cgs_check_data.TPR_owner,cgs_check_data.Compal_owner,cgs_check_data.TPR_FA,cgs_check_data.Action,cgs_check_data.Compal_check as Compal_check,cgs_check_data.update_time from cgs_check_data where cgs_check_data.Compal_check is null or cgs_check_data.Compal_check='') UNION all (select distinct ceb_check_data.Model ,ceb_check_data.PPID,ceb_check_data.Station,ceb_check_data.Fail_Item,ceb_check_data.Fail_Detail as fdetail,ceb_check_data.Test_time,ceb_check_data.Correct,ceb_check_data.TPR_owner,ceb_check_data.Compal_owner,ceb_check_data.TPR_FA,ceb_check_data.Action,ceb_check_data.Compal_check as Compal_check,ceb_check_data.update_time from ceb_check_data where ceb_check_data.Compal_check is null or ceb_check_data.Compal_check='') UNION all (select distinct igs_check_data.Model ,igs_check_data.PPID,igs_check_data.Station,igs_check_data.Fail_Item,igs_check_data.Fail_Detail as fdetail,igs_check_data.Test_time,igs_check_data.Correct,igs_check_data.TPR_owner,igs_check_data.Compal_owner,igs_check_data.TPR_FA,igs_check_data.Action,igs_check_data.Compal_check as Compal_check,igs_check_data.update_time from igs_check_data where igs_check_data.Compal_check is null) UNION all (select distinct rlc_sh_check_data.Model ,rlc_sh_check_data.PPID,rlc_sh_check_data.Station,rlc_sh_check_data.Fail_Item,rlc_sh_check_data.Fail_Detail as fdetail,rlc_sh_check_data.Test_time,rlc_sh_check_data.Correct,rlc_sh_check_data.TPR_owner,rlc_sh_check_data.Compal_owner,rlc_sh_check_data.TPR_FA,rlc_sh_check_data.Action,rlc_sh_check_data.Compal_check as Compal_check,rlc_sh_check_data.update_time from rlc_sh_check_data where rlc_sh_check_data.Compal_check is null or rlc_sh_check_data.Compal_check='') UNION all (select distinct bm_check_data.Model ,bm_check_data.PPID,bm_check_data.Station,bm_check_data.Fail_Item,bm_check_data.Fail_Detail as fdetail,bm_check_data.Test_time,bm_check_data.Correct,bm_check_data.TPR_owner,bm_check_data.Compal_owner,bm_check_data.TPR_FA,bm_check_data.Action,bm_check_data.Compal_check as Compal_check,bm_check_data.update_time from bm_check_data where bm_check_data.Compal_check is null or bm_check_data.Compal_check='') union all  (select distinct tsi_check_data.Model ,tsi_check_data.PPID,tsi_check_data.Station,tsi_check_data.Fail_Item,tsi_check_data.Fail_Detail as fdetail,tsi_check_data.Test_time,tsi_check_data.Correct,tsi_check_data.TPR_owner,tsi_check_data.Compal_owner,tsi_check_data.TPR_FA,tsi_check_data.Action,tsi_check_data.Compal_check as Compal_check,tsi_check_data.update_time from tsi_check_data where tsi_check_data.Compal_check is null or tsi_check_data.Compal_check='' order by tsi_check_data.Test_time DESC) ;

-- ----------------------------
-- View structure for tprfacaeco
-- ----------------------------
DROP VIEW IF EXISTS `tprfacaeco`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `tprfacaeco` AS select facano.tpr,facano.facano,eco.econo from facano left join   eco on facano.tpr = eco.tpr ;

-- ----------------------------
-- View structure for tprview
-- ----------------------------
DROP VIEW IF EXISTS `tprview`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `tprview` AS select tpr from tpr_name ;
