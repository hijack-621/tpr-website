...
class PHPExcel_Calculation_Statistical
{
     ...
     * @param    mixed[]        $averageArgs    Itform values
     * @return    float
     */
     ...
     *
     * @param    array of mixed        Itform Series Y
     * @param    array of mixed        Itform Series X
     * @return    float
     */
