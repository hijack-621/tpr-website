...
//            if(strpos($_FILES['file'.$i]['name'],"VGA")!==false){
//                $temp=4;
//                $folder="RY_Report_VGA";
//            }elseif (strpos($_FILES['file'.$i]['name'],"MB")!==false){
//                $temp=9;
//                $folder="RY_Report_MB";
//            }
//
...
//            if(strpos($_FILES['file'.$i]['name'],"VGA")!==false){
//                $temp=5;
//                $folder="RRR_Report_VGA";
//            }elseif (strpos($_FILES['file'.$i]['name'],"MB")!==false){
//                $temp=10;
//                $folder="RRR_Report_MB";
//            }
...
//        }
    ...
    if (!file_exists($path."/".$folder)){
        ...
        if (!file_exists($ph."/Temp".$temp)){
                ...
                //die($ph."/Temp".$temp."/".$weeks.".temp");
               // chmod('D:\phpstudy_pro\WWW\Report\TPR Report\VFIR\Temp',0775);
                $myfile=fopen($ph."/Temp".$temp."/".$weeks.".temp","w");
            }
            }
