...
$.ajax({
	...
	success:function(msg){
		...
		if(msg.length==1){
			...
			var td=document.getElementsByName("attach_2");
			var td5=document.getElementsByName("attach_5");
			for(var i=0;i<td.length;i++){
				var a=document.createElement("a");
				var img=document.createElement("img");
				a.href=msg[0];
            ...
            a5.download=file_arr4[file_arr4.length-1];
            td5[0].appendChild(a5);
            a5.appendChild(img);
...
<nav class="nav" style="margin-left:30px;margin-bottom:30px">
	...
	<div style="width:900px;position: absolute;margin-top: -25px;margin-left: 28% " >
		...
		<table class="table table-bordered table-condensed" style="text-align:center; background-color:#FFF;margin-top: 120px;table-layout: fixed;height: 400px;vertical-align: middle;width: 1260px" id="step-tb" >
