...
<title>Program System Show</title>
...
<table class="table table-bordered table-hover table-condensed" style="width: 1160px;margin: 0 auto;" id="tb-data">
...
function load(){
	...
	$.ajax({
		...
		dataType:'json',
		url:"Controller.php",
		data:{action:'NPIController/getUnclose',ptpr:ptpr,tflag:'Normal'},
...
function search() {
	...
	if (tpr==null&&model==nul&&station==null||tpr==""&&model==""&&station==''){
    ...
    $.ajax({
        ...
        dataType:'json',
        url:"Controller.php",
        data:{action:'NPIController/getSearch',urldata:search,flag:'Normal'},
        success:function(msg){
            console.log(msg);
            let endarr = {};
            for(x in msg){
...
function show_all(){
    $.ajax({
        ...
        dataType:'json',
        url:"Controller.php",
        data:{action:'NPIController/getAll',flag:'Normal'},
        success:function(msg){
            console.log(msg);
            let endarr = {};
            for(x in msg){
...
function show_close(){
    $.ajax({
        ...
        dataType:'json',
        url:"Controller.php",
        data:{action:'NPIController/getclose',flag:'Normal'},
        success:function(msg){
            console.log(msg);
            let endarr = {};
            for(x in msg){
