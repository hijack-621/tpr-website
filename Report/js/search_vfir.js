function load(){
	...
	$.ajax({
		type:"post",
		url:"../../server/search_VFIR/search_VFIR_server.php",
		data:{flag:flag},
		dataType:"json",
	...
	var ra_16=document.getElementById('ra_rr_pot');
		...
		ra_16.style.background="url(../../../images/label_1.png) no-repeat";
					...
					ra_13.style.background="url(../../../images/label_2.png) no-repeat";
						...
						}else if(d_brra[x].indexOf("CID")>0){
...
var tprs="";
	$(function(){
		...
		location.href='../login_registered/login.html';
	}else if(msg==5){
...
function delete_file(paths,tpr){
	...
	type:'post',
	dataType:'json',
	url:'../../server/search_VFIR/Search_VIFR_pro.php',
